...
function GetRentDetails()
{
	global $con;
		$output = array();
		$query = "SELECT month_year, room_number, water_front, water_back, eb_bill, maintenance, Notes, water_bill FROM rent_details WHERE month_year = DATE_FORMAT(CURDATE(), '%Y-%m') ORDER BY room_number ";
